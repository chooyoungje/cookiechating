...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "3KxO6gP8SHEq0Er57giP";
	private final static String CLIENT_SECRET = "kaFVgIyzu4";

	private final static String REDIRECT_URI = "http://localhost:8090/ex/naverloginok";
