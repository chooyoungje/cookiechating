...
public class KakaoLoginApi {
	...
	private final static String K_CLIENT_ID = "	06f4f9c7884f10a70b1b4bf36adf32e4"; 
	// 카카오 개발자 페이지에서  로그인 Redirect URI 에 설정한 값 
	private final static String K_REDIRECT_URI = "http://localhost:8090/ex/kakaologinok";
